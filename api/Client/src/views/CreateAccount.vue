    ...
    <div class="login-card">
      <div class="form-container">
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            <label for="codeParrainage">Code parainage:</label>
            <input type="text" id="codeParrainage" v-model="codeParrainage" >
          </div>
        </div>
  ...
  methods: {
    register() {
      const userData = {
        ...
        axios.post('http://localhost/app/auth/register', userData)
  .then(response => {
